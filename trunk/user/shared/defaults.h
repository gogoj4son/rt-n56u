...
#define DEF_WLAN_2G_SSID	BOARD_PID "J-Link"
#define DEF_WLAN_5G_SSID	BOARD_PID "J-Link5"
#define DEF_WLAN_2G_GSSID	BOARD_PID "J-Guest"
#define DEF_WLAN_5G_GSSID	BOARD_PID "J-Guest5"
